<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="publisher.aspx.cs" Inherits="EasyReportingTool.publisher" %>
...
<head runat="server">
    ...
    <script>
        function save() {
            jQuery.ajax({
                url: "addReport.aspx?server=" + $("#server").val() + "&catalog=" + $("#catalog").val() + "&username=" + $("#username").val() + "&password=" + $("#password").val() + "&sql=" + $("#sql").val().replace(/\n/g, " ").replace(/\r/g, " "),
...
<body>
    ...
    <div>
            ...
            <input placeholder="DB Username" type="text" id="username" /><br/>
            <input placeholder="DB Password" type="password" id="password" /><br/>
